...
2. Gas计量体系
   ...
   - 操作消耗Gas示例：
    ```go
    ctx.GasMeter().ConsumeGas(10, "transfer coins")
    ```
...
2. 实现Handler接口
```go
func handleMsgSend(ctx sdk.Context, k Keeper, msg MsgSend) (*sdk.Result, error) {
...
3. 注册ABCI生命周期钩子
```go
app.mm.SetBeginBlocker(func(ctx sdk.Context, req abci.RequestBeginBlock) abci.ResponseBeginBlock {
